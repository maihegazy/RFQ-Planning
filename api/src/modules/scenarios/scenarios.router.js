...
const { createSchema, updateSchema, listByRfqSchema, cloneSchema, diffSchema, compareSchema } = require('./scenarios.validation');
...
router.get('/:id/calculate', ctrl.calculate);
